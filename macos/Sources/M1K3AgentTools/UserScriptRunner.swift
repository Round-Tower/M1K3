...
// NSUserUnixTask and the Application Scripts folder are macOS-only — the
// hands are a Mac-interactive feature (charter rule 1; the mobile shells
// never wire scriptExecution). Gating the ADAPTER keeps M1K3AgentTools
// cross-compiling for iOS/visionOS; the pure tools above it stay portable.
// (Found 2026-08-24: this file broke the M1K3iOS build post-#147.)
#if os(macOS)
